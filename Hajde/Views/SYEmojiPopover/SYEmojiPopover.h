...
@interface SYEmojiPopover : UIViewController <UITableViewDataSource, UITableViewDelegate, UIScrollViewDelegate>
{
@private
    ...
    UIView *pageView;
    UIButton *emojiButton0;
    UIButton *emojiButton1;
    UIButton *emojiButton2;
    UIButton *emojiButton3;
    UIButton *emojiButton4;
}
