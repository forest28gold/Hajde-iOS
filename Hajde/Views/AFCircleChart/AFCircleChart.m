...
- (instancetype)initWithCoder:(NSCoder *)aDecoder
{
    if (self = [super initWithCoder:aDecoder]) {
        ...
        self.bottomLayerColor = [UIColor colorWithRed:137/255.0 green:108/255.0 blue:229/255.0 alpha:1.0];
...
{
    NSString *percentSignal = @"%";
    NSString *valueString = [NSString stringWithFormat:@"%ld%@", self.value, percentSignal];
...
//    NSString *fullString = [NSString stringWithFormat:@"%@%@", valueString, totalString];
    NSString *fullString = [NSString stringWithFormat:@"%@", valueString];
...
//    [fullAS addAttribute:NSForegroundColorAttributeName value:[UIColor whiteColor] range:NSMakeRange(valueString.length, totalString.length)];
