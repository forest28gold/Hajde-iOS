...
@interface HDNewestPostsViewController () <UITableViewDragLoadDelegate, UIGestureRecognizerDelegate>
{
    int _dataCount;
    BOOL tempIsOn;
}
...
@implementation HDNewestPostsViewController
...
//                double latitude = [record.latitude doubleValue];
//                double longitude = [record.longitude doubleValue];
//                
...
//                
//                int distance = [[GlobalData sharedGlobalData] getDistance:loc1 toLocation:loc2];
//                
//                
...
- (void)onSetEmptyView {
    ...
    if ([GlobalData sharedGlobalData].g_arrayNewestPost.count > 0) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([postData.type isEqualToString:POST_TYPE_AUDIO]) {
        ...
        NSLog(@"========= Type : %@  userID : %@   time : %@   lat : %@  lng :  %@=======", postData.type, postData.userID, postData.time, postData.latitude, postData.longitude);
        ...
        NSLog(@"========= Type : %@ Content : %@  ID : %@  userID : %@   time : %@   lat : %@  lng :  %@=======", postData.type, postData.content, postData.objectId, postData.userID, postData.time, postData.latitude, postData.longitude);
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    PostData *dataDict = [GlobalData sharedGlobalData].g_arrayNewestPost[indexPath.row];
...
- (void)onLikePost:(id)sender {
    ...
    [HDUtility likePostInBackground:indexPath dataArray:[GlobalData sharedGlobalData].g_arrayNewestPost];
...
- (void)onDislikePost:(id)sender {
    ...
    [HDUtility dislikePostInBackground:sender indexPath:indexPath dataArray:[GlobalData sharedGlobalData].g_arrayNewestPost];
