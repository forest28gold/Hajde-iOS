//
//  HDMyMostCommentedViewController.m
//  Hajde
//
...
#import "HDMyMostCommentedViewController.h"
#import "HDPostTableViewCell.h"

static NSString *HDPostTableViewCellIdentifier = @"HDPostTableViewCellIdentifier";

@interface HDMyMostCommentedViewController () <UITableViewDragLoadDelegate, UIGestureRecognizerDelegate>
{
    int _dataCount;
    BOOL tempIsOn;
    int tempPostsCount;
...
@implementation HDMyMostCommentedViewController
...
- (void)viewDidLoad {
    ...
    SVPROGRESSHUD_SHOW;
    [self initLoadMyMostCommentedData];
...
- (void)initLoadMyMostCommentedData {
    
    [GlobalData sharedGlobalData].g_arrayMyMostCommentedPost = [[NSMutableArray alloc] init];
    tempPostsCount = 0;
        ...
        if (posts.data.count > 0) {
            ...
            for (Post *post in posts.data) {
                ...
                if (![record.reportTypeArray containsObject:[GlobalData sharedGlobalData].g_userInfo.userID]) {
                    [[GlobalData sharedGlobalData].g_arrayMyMostCommentedPost addObject:record];
                    tempPostsCount ++;
                }
...
- (void)onSetEmptyView {
    ...
    if ([GlobalData sharedGlobalData].g_arrayMyMostCommentedPost.count > 0) {
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    return [GlobalData sharedGlobalData].g_arrayMyMostCommentedPost.count;
}

- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    
    PostData *postData = [GlobalData sharedGlobalData].g_arrayMyMostCommentedPost[indexPath.row];
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    PostData *dataDict = [GlobalData sharedGlobalData].g_arrayMyMostCommentedPost[indexPath.row];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [GlobalData sharedGlobalData].g_postData = [GlobalData sharedGlobalData].g_arrayMyMostCommentedPost[indexPath.row];
...
- (void)onLikePost:(id)sender {
    ...
    [HDUtility likePostInBackground:indexPath dataArray:[GlobalData sharedGlobalData].g_arrayMyMostCommentedPost];
...
- (void)onDislikePost:(id)sender {
    ...
    [HDUtility dislikePostInBackground:sender indexPath:indexPath dataArray:[GlobalData sharedGlobalData].g_arrayMyMostCommentedPost];
