...
@interface HDMostVotesViewController () <UITableViewDragLoadDelegate, UIGestureRecognizerDelegate>
{
    int _dataCount;
    BOOL tempIsOn;
}
...
@implementation HDMostVotesViewController
...
- (void)onSetEmptyView {
    ...
    if ([GlobalData sharedGlobalData].g_arrayMostVotesPost.count > 0) {
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    PostData *dataDict = [GlobalData sharedGlobalData].g_arrayMostVotesPost[indexPath.row];
...
- (void)onLikePost:(id)sender {
    ...
    [HDUtility likePostInBackground:indexPath dataArray:[GlobalData sharedGlobalData].g_arrayMostVotesPost];
...
- (void)onDislikePost:(id)sender {
    ...
    [HDUtility dislikePostInBackground:sender indexPath:indexPath dataArray:[GlobalData sharedGlobalData].g_arrayMostVotesPost];
