...
@interface HDMyPostsViewController () <ViewPagerDataSource, ViewPagerDelegate>
{
    HDMyNewestPostsViewController *viewNewestCtrl;
    HDMyMostCommentedViewController *viewMostCommentedCtrl;
    HDMyMostVotesViewController *viewMostVotesCtrl;
...
@implementation HDMyPostsViewController
...
- (void)viewDidLoad {
    ...
    viewNewestCtrl = [self.storyboard instantiateViewControllerWithIdentifier:VIEW_MY_NEWEST_POSTS];
    viewMostCommentedCtrl = [self.storyboard instantiateViewControllerWithIdentifier:VIEW_MY_MOST_COMMENTED];
    viewMostVotesCtrl = [self.storyboard instantiateViewControllerWithIdentifier:VIEW_MY_MOST_VOTES];
