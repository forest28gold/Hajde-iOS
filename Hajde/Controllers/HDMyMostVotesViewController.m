...
#import "HDMyMostVotesViewController.h"
#import "HDPostTableViewCell.h"

static NSString *HDPostTableViewCellIdentifier = @"HDPostTableViewCellIdentifier";

@interface HDMyMostVotesViewController () <UITableViewDragLoadDelegate, UIGestureRecognizerDelegate>
{
    int _dataCount;
    BOOL tempIsOn;
    int tempPostsCount;
...
@implementation HDMyMostVotesViewController
...
- (void)initLoadMyMostVotesData {
    
    [GlobalData sharedGlobalData].g_arrayMyMostVotesPost = [[NSMutableArray alloc] init];
    tempPostsCount = 0;
        ...
        if (posts.data.count > 0) {
            ...
            for (Post *post in posts.data) {
                ...
                if (![record.reportTypeArray containsObject:[GlobalData sharedGlobalData].g_userInfo.userID]) {
                    [[GlobalData sharedGlobalData].g_arrayMyMostVotesPost addObject:record];
                    tempPostsCount ++;
                }
...
- (void)onSetEmptyView {
    ...
    if ([GlobalData sharedGlobalData].g_arrayMyMostVotesPost.count > 0) {
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    return [GlobalData sharedGlobalData].g_arrayMyMostVotesPost.count;
}

- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    
    PostData *postData = [GlobalData sharedGlobalData].g_arrayMyMostVotesPost[indexPath.row];
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    PostData *dataDict = [GlobalData sharedGlobalData].g_arrayMyMostVotesPost[indexPath.row];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [GlobalData sharedGlobalData].g_postData = [GlobalData sharedGlobalData].g_arrayMyMostVotesPost[indexPath.row];
...
- (void)onLikePost:(id)sender {
    ...
    [HDUtility likePostInBackground:indexPath dataArray:[GlobalData sharedGlobalData].g_arrayMyMostVotesPost];
...
- (void)onDislikePost:(id)sender {
    ...
    [HDUtility dislikePostInBackground:sender indexPath:indexPath dataArray:[GlobalData sharedGlobalData].g_arrayMyMostVotesPost];
