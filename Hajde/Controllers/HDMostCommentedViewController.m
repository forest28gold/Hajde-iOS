//
//  HDMostCommentedViewController.m
//  Hajde
//
...
@interface HDMostCommentedViewController () <UITableViewDragLoadDelegate, UIGestureRecognizerDelegate>
{
    int _dataCount;
    BOOL tempIsOn;
}
...
@implementation HDMostCommentedViewController
...
- (void)onSetEmptyView {
    ...
    if ([GlobalData sharedGlobalData].g_arrayMostCommentedPost.count > 0) {
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    PostData *dataDict = [GlobalData sharedGlobalData].g_arrayMostCommentedPost[indexPath.row];
...
- (void)onLikePost:(id)sender {
    ...
    [HDUtility likePostInBackground:indexPath dataArray:[GlobalData sharedGlobalData].g_arrayMostCommentedPost];
...
- (void)onDislikePost:(id)sender {
    ...
    [HDUtility dislikePostInBackground:sender indexPath:indexPath dataArray:[GlobalData sharedGlobalData].g_arrayMostCommentedPost];
